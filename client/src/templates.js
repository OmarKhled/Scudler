    ...
    body: [
      {
        sectionNumber: 1,
        lecture: {
          lectureName: "MATH0002 Lecture - Section 1",
        ...
        tutorial: [
          {
            tutorialName: "MATH0002 - Tutorial 1A",
            tutorialPrefix: "1A",
            ta: "Mohamed farag",
            slots: [
              {
          ...
          {
            tutorialName: "MATH0002 - Tutorial 1B",
            tutorialPrefix: "1B",
            ta: "Menna Mohamed",
            slots: [
              {
      ...
      },
      {
        sectionNumber: 2,
        lecture: {
          lectureName: "MATH0002 Lecture - Section 2",
        ...
        tutorial: [
          {
            tutorialName: "MATH0002 - Tutorial 2A",
            tutorialPrefix: "2A",
            ta: "Mohamed Farag",
            slots: [
              {
          ...
          {
            tutorialName: "MATH0002 - Tutorial 2B",
            tutorialPrefix: "2B",
            ta: "Menna Mohamed",
            slots: [
              {
      ...
      },
      {
        sectionNumber: 3,
        lecture: {
          lectureName: "MATH0002 Lecture - Section 3",
        ...
        tutorial: [
          {
            tutorialName: "MATH0002 - Tutorial 3A",
            tutorialPrefix: "3A",
            ta: "Mohamed Farag",
            slots: [
              {
          ...
          {
            tutorialName: "MATH0002 - Tutorial 3B",
            tutorialPrefix: "3B",
            ta: "Menna Farag",
            slots: [
              {
      ...
      },
      {
        sectionNumber: 4,
        lecture: {
          lectureName: "MATH0002 Lecture - Section 4",
          professor: "Mohamed Mamdouh",
          slots: [
            {
              day: 0,
        ...
        tutorial: [
          {
            tutorialName: "MATH0002 - Tutorial 4A",
            tutorialPrefix: "4A",
            ta: "Mohamed Farag",
            slots: [
              {
          ...
          {
            tutorialName: "MATH0002 - Tutorial 4B",
            tutorialPrefix: "4B",
            ta: "Menna Mohamed",
            slots: [
              {
